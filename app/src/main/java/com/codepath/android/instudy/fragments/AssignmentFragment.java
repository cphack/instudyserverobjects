...
public class AssignmentFragment extends Fragment implements DatePickerFragment.DatePickerFragmentListener {
    ...
    public void showDatePickerDialog(View v, boolean isStartDate) {
        ...
        newFragment.setTargetFragment(AssignmentFragment.this, 300);
