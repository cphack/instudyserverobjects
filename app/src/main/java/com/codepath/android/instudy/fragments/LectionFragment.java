...
public class LectionFragment extends Fragment implements DatePickerFragment.DatePickerFragmentListener {
    ...
    public void showDatePickerDialog(View v, boolean isStartDate) {
        ...
        newFragment.setTargetFragment(LectionFragment.this, 300);
